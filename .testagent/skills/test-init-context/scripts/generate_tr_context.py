    ...
    for task in tasks:
        ...
        for tr in task.get("tr_list") or []:
            ...
            context = {
                ...
                "resolve_description": tr.get("resolve_description") or "",
                "creator": tr.get("creator") or "",
                "tr_resource_type": tr.get("tr_resource_type") or "",
                "relation_function": tr.get("relation_function") or "",
                "relation_feature": tr.get("relation_feature") or "",
                "scene_list": tr.get("scene_list") or [],
                "function_list": tr.get("function_list") or [],
                "feature_list": tr.get("feature_list") or [],
                "pbi": str(pbi),
